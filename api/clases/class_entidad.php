...
//echo ("dentro de insertarEntidad");
...
*/
        ...
        $sql ="select nu_tipo_entidad as nu_tipo_entidad_pry, in_clasificacion_tipo_ent as in_clasificacion_tipo_ent_pry, descripcion 
                ...
                where nu_entidad = 14 AND
                in_clasificacion_ent='PRY' AND 
                dni_enterprise='1' AND 
                nu_tipo_entidad_doc_ent = 7 AND 
                in_clasificacion_tipo_ent_doc_ent= 'RIF' order by nu_tipo_entidad";
        ...
        function filtrar_entidades_por_proyecto($nu_tipo_entidad_pry,
            ...
            $sql="SELECT descripcion, nu_tipo_entidad,in_clasificacion_tipo_ent,nu_entidad,in_clasificacion_ent, `dni_enterprise` from tipo_entidad 
                        WHERE 
