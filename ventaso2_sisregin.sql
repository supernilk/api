...
-- Tiempo de generación: 15-01-2023 a las 16:13:31
...
('V23166229', 3, 'CDV', 'Tony Richard', 'Tarco Tineo', '3207609961', 'calle 21 #105A05 Bogotá ', 'tonytarco@hotmail.com'),
...
INSERT INTO `usuario` (`dni`, `nu_tipo_entidad_doc`, `in_clasificacion_tipo_ent_doc`, `username`, `password`, `emailuser`, `nu_tipo_entidad_prf`, `in_clasificacion_tipo_ent_prf`, `nu_tipo_entidad_sta`, `in_clasificacion_tipo_ent_sta`, `nu_tipo_entidad_set`, `in_clasificacion_tipo_ent_set`, `dni_enterprise`, `nu_tipo_entidad_doc_ent`, `in_clasificacion_tipo_ent_doc_ent`) VALUES
('V23166229', 3, 'CDV', 'TTARCO', 'V23166229', 'tonytarco@hotmail.com', 1, 'MNS', 2, 'INC', 2, 'NEG', 'J-403961441', 7, 'RIF'),
('C123456', 1, 'CDC', 'JTORRES', 'C123456', 'jtorres@gmail.com', 3, 'ANI', 2, 'INC', 2, 'NEG', 'J-403961441', 7, 'RIF'),
('C123', 1, 'CDC', 'GTOLEDO', 'S123456', 'gtoledo@consultoriaeconomicasas.com', 3, 'ANI', 2, 'INC', 2, 'NEG', 'J-403961441', 7, 'RIF');
