...
REPLACE INTO `enterprise` (`dni`, `nu_tipo_entidad_doc`, `in_clasificacion_tipo_ent_doc`, `Website`) VALUES
...
REPLACE INTO `entidad` (`nu_entidad`, `in_clasificacion_ent`, `descripcion`, `dni_enterprise`, `nu_tipo_entidad_doc_ent`, `in_clasificacion_tipo_ent_doc_ent`) VALUES
...
REPLACE INTO `licencias` (`id`, `nu_tipo_ent_doc`, `in_clasificacion_tipo_ent_doc`, `dni`, `password`, `emailuser`, `nu_tipo_entidad_sta`, `in_clasificacion_tipo_ent_sta`) VALUES
...
REPLACE INTO `persona` (`dni`, `nu_tipo_entidad_doc`, `in_clasificacion_tipo_ent_doc`, `nombre`, `apellido`, `telefono`, `direccion`, `email`) VALUES
...
REPLACE INTO `tipo_entidad` (`nu_tipo_entidad`, `in_clasificacion_tipo_ent`, `nu_entidad`, `in_clasificacion_ent`, `descripcion`, `dni_enterprise`, `nu_tipo_entidad_doc_ent`, `in_clasificacion_tipo_ent_doc_ent`) VALUES
...
REPLACE INTO `token` (`ID`, `ID_Usuario`, `token`, `fechaTope`) VALUES
...
REPLACE INTO `usuario` (`ID_Usuario`, `dni`, `nu_tipo_entidad_doc`, `in_clasificacion_tipo_ent_doc`, `username`, `password`, `emailuser`, `nu_tipo_entidad_prf`, `in_clasificacion_tipo_ent_prf`, `nu_tipo_entidad_sta`, `in_clasificacion_tipo_ent_sta`, `nu_tipo_entidad_set`, `in_clasificacion_tipo_ent_set`, `dni_enterprise`, `nu_tipo_entidad_doc_ent`, `in_clasificacion_tipo_ent_doc_ent`) VALUES
