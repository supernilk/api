...
-- Tiempo de generación: 11-02-2023 a las 09:13:39
...
(11, '0', 1, 'CDC', '123456.', 'nilk.ao@gmail.com', 1, 'ACT');
...
(78, '0', 1, 'CDC', 'El', 'Pepe', '', '', 'elpepe@gmail.com'),
(72, '0', 1, 'CDC', 'john', 'Barragan', '', '', 'nilk.ao@gmail.com'),
(71, '3', 5, 'RUT', '', '', '', '', '');
...
CREATE TABLE `tipo_entidad` (
  ...
  `nu_tipo_entidad_sta` int(8) NOT NULL,
  `in_clasificacion_tipo_ent_sta` varchar(3) NOT NULL,
  `nu_tipo_entidad_pry` int(8) DEFAULT NULL,
  `in_clasificacion_tipo_ent_pry` varchar(3) DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
(0, 'CN0', 8, 'CNT', '', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(1, 'CN1', 8, 'CNT', '1A3D', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(2, 'CN2', 8, 'CNT', '1A3P', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(3, 'CN3', 8, 'CNT', '1A6P', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(4, 'CN4', 8, 'CNT', '1A7P', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(6, 'CN6', 8, 'CNT', '1A8P', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(7, 'CN7', 8, 'CNT', '1A9D', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(8, 'CN8', 8, 'CNT', '1A9P', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(9, 'CN9', 8, 'CNT', '1AFD', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(10, 'CM0', 8, 'CNT', '1AFP', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(11, 'CM1', 8, 'CNT', '1AID', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(12, 'CM2', 8, 'CNT', '1AIP', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(13, 'CM3', 8, 'CNT', '1AJD', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(14, 'CM4', 8, 'CNT', '1AJP', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(0, 'AL0', 9, 'ALM', '', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(1, 'AL1', 9, 'ALM', '1000', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(3, 'AL3', 9, 'ALM', '3000', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(4, 'AL4', 9, 'ALM', '4000', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(5, 'AL5', 9, 'ALM', '4100', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(6, 'AL6', 9, 'ALM', '5000', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(7, 'AL7', 9, 'ALM', '6000', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(8, 'AL8', 9, 'ALM', '6001', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(9, 'AL9', 9, 'ALM', '6002', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(10, 'AK1', 9, 'ALM', '7000', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(11, 'AK2', 9, 'ALM', '9000', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(12, 'AK3', 9, 'ALM', '9100', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(1, 'B01', 11, 'LOC', 'B01', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(2, 'B02', 11, 'LOC', 'B02', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(3, 'B03', 11, 'LOC', 'B03', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(4, 'B04', 11, 'LOC', 'B04', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(5, 'B05', 11, 'LOC', 'B05', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(6, 'C01', 11, 'LOC', 'B06', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(7, 'C02', 11, 'LOC', 'B07', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(8, 'C03', 11, 'LOC', 'B08', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(9, 'C04', 11, 'LOC', 'B09', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(10, 'C05', 11, 'LOC', 'B10', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(11, 'C06', 11, 'LOC', 'B11', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(12, 'C07', 11, 'LOC', 'B12', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(13, 'C08', 11, 'LOC', 'B13', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(14, 'C09', 11, 'LOC', 'B14', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(15, 'C10', 11, 'LOC', 'B15', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(16, 'C11', 11, 'LOC', 'C01', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(17, 'C12', 11, 'LOC', 'C02', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(18, 'C13', 11, 'LOC', 'C03', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(19, 'C14', 11, 'LOC', 'C04', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(20, 'C15', 11, 'LOC', 'C05', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(21, 'C16', 11, 'LOC', 'C06', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(22, 'C17', 11, 'LOC', 'C07', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(23, 'C18', 11, 'LOC', 'C08', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(24, 'C19', 11, 'LOC', 'C09', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(25, 'C20', 11, 'LOC', 'C10', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(26, 'C21', 11, 'LOC', 'C11', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(27, 'C22', 11, 'LOC', 'C12', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(28, 'C23', 11, 'LOC', 'C13', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(29, 'C24', 11, 'LOC', 'C14', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(30, 'C25', 11, 'LOC', 'C15', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(31, 'C26', 11, 'LOC', 'C16', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(32, 'C27', 11, 'LOC', 'C17', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(33, 'C28', 11, 'LOC', 'C18', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(34, 'C29', 11, 'LOC', 'C19', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(35, 'C30', 11, 'LOC', 'C20', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(36, 'C31', 11, 'LOC', 'C21', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(37, 'C32', 11, 'LOC', 'C22', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(38, 'C33', 11, 'LOC', 'C23', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(39, 'C34', 11, 'LOC', 'C24', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(40, 'C35', 11, 'LOC', 'C25', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(41, 'C36', 11, 'LOC', 'C26', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(42, 'C37', 11, 'LOC', 'C27', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(43, 'C38', 11, 'LOC', 'C28', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(44, 'C39', 11, 'LOC', 'C29', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(45, 'C40', 11, 'LOC', 'C30', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(46, 'C41', 11, 'LOC', 'C31', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(47, 'C42', 11, 'LOC', 'C32', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(48, 'C43', 11, 'LOC', 'C33', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(49, 'C44', 11, 'LOC', 'C34', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(50, 'C45', 11, 'LOC', 'C35', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(51, 'C46', 11, 'LOC', 'C36', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(52, 'C47', 11, 'LOC', 'C37', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(53, 'C48', 11, 'LOC', 'C38', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(54, 'C49', 11, 'LOC', 'C39', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(55, 'C50', 11, 'LOC', 'C40', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(56, 'C51', 11, 'LOC', 'P01', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(57, 'C52', 11, 'LOC', 'P02', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(58, 'C53', 11, 'LOC', 'P03', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(59, 'C54', 11, 'LOC', 'P04', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(60, 'C55', 11, 'LOC', 'P05', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(61, 'C56', 11, 'LOC', 'P06', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(62, 'C57', 11, 'LOC', 'P07', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(63, 'C58', 11, 'LOC', 'P08', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(64, 'C59', 11, 'LOC', 'P09', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(65, 'C60', 11, 'LOC', 'P10', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(66, 'P01', 11, 'LOC', 'P11', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(67, 'P02', 11, 'LOC', 'P12', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(68, 'P03', 11, 'LOC', 'P13', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(69, 'P04', 11, 'LOC', 'P14', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(70, 'P05', 11, 'LOC', 'P15', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(71, 'LOC', 9, 'LOC', 'Rabano', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(72, 'LOC', 11, 'LOC', '', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(73, 'LOC', 11, 'LOC', 'A10', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(74, 'LOC', 11, 'LOC', 'A10', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(75, 'LOC', 11, 'LOC', 'A10', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(76, 'LOC', 11, 'LOC', 'A10', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(77, 'LOC', 0, 'LOC', 'A10', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(78, 'LOC', 7, 'LOC', 'A10', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(79, 'LOC', 7, 'LOC', 'A10', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(80, 'LOC', 7, 'LOC', 'A101', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(81, 'LOC', 11, 'LOC', 'sNILK', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(82, 'LOC', 11, 'LOC', 'sNILK', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(83, 'LOC', 11, 'LOC', 'sNILK', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(84, 'LOC', 11, 'LOC', 'sNILK', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(85, 'LOC', 11, 'LOC', 'sNILK', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(86, 'LOC', 11, 'LOC', 'sNILK', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(87, 'LOC', 11, 'LOC', 'test', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(88, 'LOC', 11, 'LOC', 'test2', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(89, 'LOC', 11, 'LOC', 'test2', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(90, 'LOC', 11, 'LOC', 'test2', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(0, 'CN0', 8, 'CNT', '', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(1, 'CN1', 8, 'CNT', '1A3D', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(2, 'CN2', 8, 'CNT', '1A3P', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(3, 'CN3', 8, 'CNT', '1A6P', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(4, 'CN4', 8, 'CNT', '1A7P', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(6, 'CN6', 8, 'CNT', '1A8P', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(7, 'CN7', 8, 'CNT', '1A9D', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(8, 'CN8', 8, 'CNT', '1A9P', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(9, 'CN9', 8, 'CNT', '1AFD', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(10, 'CM0', 8, 'CNT', '1AFP', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(11, 'CM1', 8, 'CNT', '1AID', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(12, 'CM2', 8, 'CNT', '1AIP', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(13, 'CM3', 8, 'CNT', '1AJD', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(14, 'CM4', 8, 'CNT', '1AJP', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(0, 'AL0', 9, 'ALM', '', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(1, 'AL1', 9, 'ALM', '1000', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(3, 'AL3', 9, 'ALM', '3000', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(4, 'AL4', 9, 'ALM', '4000', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(5, 'AL5', 9, 'ALM', '4100', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(6, 'AL6', 9, 'ALM', '5000', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(7, 'AL7', 9, 'ALM', '6000', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(8, 'AL8', 9, 'ALM', '6001', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(9, 'AL9', 9, 'ALM', '6002', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(10, 'AK1', 9, 'ALM', '7000', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(11, 'AK2', 9, 'ALM', '9000', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(12, 'AK3', 9, 'ALM', '9100', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(1, 'B01', 11, 'LOC', 'B01', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(2, 'B02', 11, 'LOC', 'B02', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(3, 'B03', 11, 'LOC', 'B03', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(4, 'B04', 11, 'LOC', 'B04', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(5, 'B05', 11, 'LOC', 'B05', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(6, 'C01', 11, 'LOC', 'B06', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(7, 'C02', 11, 'LOC', 'B07', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(8, 'C03', 11, 'LOC', 'B08', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(9, 'C04', 11, 'LOC', 'B09', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(10, 'C05', 11, 'LOC', 'B10', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(11, 'C06', 11, 'LOC', 'B11', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(12, 'C07', 11, 'LOC', 'B12', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(13, 'C08', 11, 'LOC', 'B13', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(14, 'C09', 11, 'LOC', 'B14', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(15, 'C10', 11, 'LOC', 'B15', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(16, 'C11', 11, 'LOC', 'C01', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(17, 'C12', 11, 'LOC', 'C02', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(18, 'C13', 11, 'LOC', 'C03', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(19, 'C14', 11, 'LOC', 'C04', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(20, 'C15', 11, 'LOC', 'C05', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(21, 'C16', 11, 'LOC', 'C06', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(22, 'C17', 11, 'LOC', 'C07', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(23, 'C18', 11, 'LOC', 'C08', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(24, 'C19', 11, 'LOC', 'C09', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(25, 'C20', 11, 'LOC', 'C10', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(26, 'C21', 11, 'LOC', 'C11', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(27, 'C22', 11, 'LOC', 'C12', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(28, 'C23', 11, 'LOC', 'C13', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(29, 'C24', 11, 'LOC', 'C14', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(30, 'C25', 11, 'LOC', 'C15', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(31, 'C26', 11, 'LOC', 'C16', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(32, 'C27', 11, 'LOC', 'C17', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(33, 'C28', 11, 'LOC', 'C18', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(34, 'C29', 11, 'LOC', 'C19', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(35, 'C30', 11, 'LOC', 'C20', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(36, 'C31', 11, 'LOC', 'C21', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(37, 'C32', 11, 'LOC', 'C22', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(38, 'C33', 11, 'LOC', 'C23', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(39, 'C34', 11, 'LOC', 'C24', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(40, 'C35', 11, 'LOC', 'C25', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(41, 'C36', 11, 'LOC', 'C26', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(42, 'C37', 11, 'LOC', 'C27', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(43, 'C38', 11, 'LOC', 'C28', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(44, 'C39', 11, 'LOC', 'C29', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(45, 'C40', 11, 'LOC', 'C30', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(46, 'C41', 11, 'LOC', 'C31', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(47, 'C42', 11, 'LOC', 'C32', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(48, 'C43', 11, 'LOC', 'C33', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(49, 'C44', 11, 'LOC', 'C34', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(50, 'C45', 11, 'LOC', 'C35', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(51, 'C46', 11, 'LOC', 'C36', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(52, 'C47', 11, 'LOC', 'C37', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(53, 'C48', 11, 'LOC', 'C38', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(54, 'C49', 11, 'LOC', 'C39', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(55, 'C50', 11, 'LOC', 'C40', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(56, 'C51', 11, 'LOC', 'P01', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(57, 'C52', 11, 'LOC', 'P02', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(58, 'C53', 11, 'LOC', 'P03', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(59, 'C54', 11, 'LOC', 'P04', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(60, 'C55', 11, 'LOC', 'P05', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(61, 'C56', 11, 'LOC', 'P06', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(62, 'C57', 11, 'LOC', 'P07', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(63, 'C58', 11, 'LOC', 'P08', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(64, 'C59', 11, 'LOC', 'P09', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(65, 'C60', 11, 'LOC', 'P10', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(66, 'P01', 11, 'LOC', 'P11', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(67, 'P02', 11, 'LOC', 'P12', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(68, 'P03', 11, 'LOC', 'P13', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(69, 'P04', 11, 'LOC', 'P14', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(70, 'P05', 11, 'LOC', 'P15', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(71, 'LOC', 9, 'LOC', 'Rabano', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(72, 'LOC', 11, 'LOC', '', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(73, 'LOC', 11, 'LOC', 'A10', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(74, 'LOC', 11, 'LOC', 'A10', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(75, 'LOC', 11, 'LOC', 'A10', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(76, 'LOC', 11, 'LOC', 'A10', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(77, 'LOC', 0, 'LOC', 'A10', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(78, 'LOC', 7, 'LOC', 'A10', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(79, 'LOC', 7, 'LOC', 'A10', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(80, 'LOC', 7, 'LOC', 'A101', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(81, 'LOC', 11, 'LOC', 'sNILK', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(82, 'LOC', 11, 'LOC', 'sNILK', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(83, 'LOC', 11, 'LOC', 'sNILK', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(84, 'LOC', 11, 'LOC', 'sNILK', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(85, 'LOC', 11, 'LOC', 'sNILK', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(86, 'LOC', 11, 'LOC', 'sNILK', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(87, 'LOC', 11, 'LOC', 'test', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(88, 'LOC', 11, 'LOC', 'test2', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(89, 'LOC', 11, 'LOC', 'test2', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(90, 'LOC', 11, 'LOC', 'test2', '4', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(0, 'CN0', 8, 'CNT', '', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(1, 'CN1', 8, 'CNT', '1A3D', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(2, 'CN2', 8, 'CNT', '1A3P', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(3, 'CN3', 8, 'CNT', '1A6P', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
...
(89, 'LOC', 11, 'LOC', 'test2', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(90, 'LOC', 11, 'LOC', 'test2', '3', 5, 'RUT', 1, 'ACT', 1, 'PRM'),
(3, 'DSH', 3, 'STA', 'Deshabilitado', NULL, NULL, NULL, 1, 'ACT', NULL, NULL);
...
(81, '33', '5dc58e867167c50aa81c0fe791656d5c526136a697f04568598801236bd64729', '1676677392');
...
CREATE TABLE `usuario` (
  ...
  `nu_tipo_entidad_doc_ent` int(8) DEFAULT NULL,
  `in_clasificacion_tipo_ent_doc_ent` varchar(3) DEFAULT NULL,
  `fecha_exp_lic` bigint(20) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
(1, 'V23166229', 3, 'CDV', 'TTARCO', 'V23166229', 'tonytarco@hotmail.com', 2, 'GGB', 2, 'INC', 2, 'NEG', '1', 7, 'RIF', 1676414723),
(2, 'C123456', 1, 'CDC', 'JTORRES', 'C123456', 'jtorres@gmail.com', 1, 'MNS', 2, 'INC', 2, 'NEG', '1', 7, 'RIF', 20240208),
(3, 'C123', 1, 'CDC', 'GTOLEDO', 'S123456', 'gtoledo@consultoriaeconomicasas.com', 3, 'ANI', 2, 'INC', 2, 'NEG', '1', 7, 'RIF', 20230303),
(33, '0', 1, 'CDC', 'Snilk', '123456', 'nilk.ao@gmail.com', 2, 'GGB', 2, 'INC', 2, 'NEG', '3', 5, 'RUT', 1707590573),
(36, '0', 1, 'CDC', 'El_PEPE', '123456789.', 'elpepe@gmail.com', 3, 'ANI', 2, 'INC', 2, 'NEG', '1', 7, 'RIF', 20240208);
